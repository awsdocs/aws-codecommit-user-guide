...
1. The page displays the contents in the default branch of your repository\. To view another branch or to view the code at a specific tag, choose the branch or tag you want to view from the list\. In the following screen shot the view is set to the **master** branch\.  
...
1. You can add an approval rule to your pull request to ensure certain conditions are met before it can be merged\. To add an approval rule to your pull request, choose the pull request from the list\. On the **Approvals** tab, choose **Create approval rule**\. 
