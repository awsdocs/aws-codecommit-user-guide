...
1. In the **Create trigger** pane, do the following:
   ...
   + In **Amazon SNS Topic**, choose a topic name from the list, or choose **Add an Amazon SNS topic ARN**, and then enter the ARN for the function\.
