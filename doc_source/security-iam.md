...
CodeCommit supports using temporary credentials\. For more information, see [Temporary Access to AWS CodeCommit Repositories](temporary-access.md)\.
...
For more information, see [Configure Cross\-Account Access to an AWS CodeCommit Repository](cross-account.md)\.