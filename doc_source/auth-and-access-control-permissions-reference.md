...
|  GitPush  |  `codecommit:GitPush` Required to push information from a local repo to an AWS CodeCommit repository\. This is an IAM policy permission only, not an API action\.  |  arn:aws:codecommit:*region*:*account\-id*:*repository\-name*  | 
